...
/******************define******************/
#define FIRE_SPEED_30 6400  //27m/s上下6800
...
#define COOLING_JUDGE() (HAL_GetTick()-Cooling_time<=5000)
...
//摩擦轮前馈参数
#define SHOOT_FIRE_L_K0 3.f
#define SHOOT_FIRE_L_K1 0.6f
#define SHOOT_FIRE_L_K2 8.f//8
#define SHOOT_FIRE_L_MINKP  0


#define SHOOT_FIRE_R_K0 3.f
#define SHOOT_FIRE_R_K1 0.6f
#define SHOOT_FIRE_R_K2 8.f//8
#define SHOOT_FIRE_R_MINKP  0
/******************struct&enum******************/
...
extern void laucher_heat_control();
