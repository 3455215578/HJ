...
//pitch最大最小绝对角
#define GIMBAL_PITCH_MAX_ABSOLUTE_ANGLE (15)
#define GIMBAL_PITCH_MIN_ABSOLUTE_ANGLE (-15)

//pitch yaw 初始ecd值
#define GIMBAL_PITCH_OFFSET_ECD 7516
#define GIMBAL_YAW_OFFSET_ECD 646
...
//普通云台pid常量
#define GIMBAL_YAW_ANGLE_PID_KP     50.f//50f
#define GIMBAL_YAW_ANGLE_PID_KI     0.4f//0.05f
#define GIMBAL_YAW_ANGLE_PID_KD     2000.0f//800.f
#define GIMBAL_YAW_ANGLE_MAX_OUT    10000.f
#define GIMBAL_YAW_ANGLE_MAX_IOUT   100.f//

#define GIMBAL_YAW_SPEED_PID_KP     200.f//200
...
#define GIMBAL_PITCH_ANGLE_PID_KP   25.0f
#define GIMBAL_PITCH_ANGLE_PID_KI   0.04f//1
#define GIMBAL_PITCH_ANGLE_PID_KD   500.f//280
#define GIMBAL_PITCH_ANGLE_MAX_OUT  400.f
#define GIMBAL_PITCH_ANGLE_MAX_IOUT 30.f

#define GIMBAL_PITCH_SPEED_PID_KP   100.f//300
#define GIMBAL_PITCH_SPEED_PID_KI   10.5f//5
#define GIMBAL_PITCH_SPEED_PID_KD   10.0f//40
...
#define GIMBAL_YAW_SPEED_PID_KP_AUTO     200.0f//180
#define GIMBAL_YAW_SPEED_PID_KI_AUTO     0.5f//50.0f
