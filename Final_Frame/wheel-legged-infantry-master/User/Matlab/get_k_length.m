...
%     Q = diag([230 0.1 1 0.1 60000 1]);
%     Q = diag([1 0.1 1 3 60000 1]);
%     Q = diag([1 0.1 11 3 60000 1]);
%       Q = diag([0.01 0.01 4 0.01 40000 1]);
%       Q = diag([0.01 0.01 40 0.01 40000 1]);
      Q = diag([0.01 0.01 100 0.01 40000 1]);
